...
import koin from '../assets/profil/coin.png';
              ...
              <div className="star-rating starRatingStyle">
                ...
                <div>
                  <form onSubmit={handleSubmit} style={{marginLeft:'25%'}}>
                    <textarea value={formData.textareaValue} onChange={handleTextareaChange} placeholder="Masukkan teks di sini" rows={4} cols={50} />
                    <br />
                  </form>
                  <div className="container d-flex justify-content-center align-items-center vh-100">
                  <button type="button" class="btn btn-warning custom-btn text-white" onClick={togglePopup} style={{marginTop:"-73%",marginLeft:"140%"}}>Kirim</button>
        ...
        <div className="modal" tabIndex="-1" role="dialog" style={{ display: 'block' }}>
          <div className="modal-dialog modal-dialog-centered" role="document">
            <div className="modal-content">
              ...
              <p style={{ fontSize: '20px' }}>Selamat Selvia Putri anda berhak <br /> mendapatkan 50 koin atas dukungan <br /> anda dalam menikmati kelezatan cita <br />rasa kuliner tanah air melalui ulasan <br /> anda !</p>
              </div>
              <button type="button" class="btn btn-warning custom-btn text-white" onClick={togglePopup}>Dapatkan</button>
            </div>
          </div>
        </div>
      )}
